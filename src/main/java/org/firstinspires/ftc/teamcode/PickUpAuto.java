...
@Autonomous(name = "Auto 1 Piece No Park", group = "Robot")
//@Disabled
...
//        if (voltageshow < 12.5 && voltageshow >= 12) {timeRatio=1.5;}
    ...
    private void auton() {
        ...
        double step1Duration = 1.0;
        double step2Duration = 2.0;
        double step3Duration = 4.0;
        double step4Duration = 1.0;
        double step5Duration = 2.0;
        double step6Duration = 1.0;
        double step7Duration = 1.0;
        double step8Duration = 5.0;
        double step9Duration = 2.0;
        double step10Duration = 3.0;
        double step11Duration = 0.1;
        double step12Duration = 3.0;
        double step13Duration = 1.0;
        double step14Duration = 1.0;
        double step15Duration = 1.0;
        double step16Duration = 1.0;
        double step17Duration = 1.0;
        double step18Duration = 2.0;
        double step19Duration = 1.0;
        double step20Duration = 1.0;
        double step21Duration = 1.0;
        ...
        if (time > step16Start && time < step16End && !step16Complete) {
            // Add your code for step 16 here
            currentArmState = ArmState.SUBMARINE;
            step16Complete = true;
        }
        if (time > step17Start && time < step17End && !step17Complete) {
            // Add your code for step 17 here
            step17Complete = true;
        }
